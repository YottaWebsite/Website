...
<?php getPagina(18); ?>
                        ...
                        <div class="col-lg-6">
                            <h5>Google maps</h5>
                            <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script><div style="overflow:hidden;height:500px;width:550px;"><div id="gmap_canvas" style="height:600px;width:650px;"></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type="text/javascript"> function init_map() {
                                    var myOptions = {zoom: 14, center: new google.maps.LatLng(52.65427529999999, 5.626848099999961), mapTypeId: google.maps.MapTypeId.HYBRID};
                                    map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);
                                    marker = new google.maps.Marker({map: map, position: new google.maps.LatLng(52.65427529999999, 5.626848099999961)});
                                    infowindow = new google.maps.InfoWindow({content: "<b>Yotta bv</b><br/>Foksdiep 37<br/>8321 MK  Urk"});
