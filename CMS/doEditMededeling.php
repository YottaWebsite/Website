...
<html lang="en">
    ...
    <body id="page-top" class="index">
        ...
        if ($_POST['titel'] != "" && $_POST['tekstvak'] != "") {
            editPost($_POST['id'], $_POST['titel'], $_POST['tekstvak']);
            header("Location: mededeling.php");
        }

        $id = editPostForm($_POST['id']);
        ?>
        <!-- Navigatie -->
        ...
        <section>
            <div class="navbar-leegte">
                <div class="container">
                    <h1>Mededeling wijzigen</h1>  <!-- titel -->
                    <a href="mededeling.php">Mededelingen weergeven</a><hr>

                    <form method="POST" action="doEditMededeling.php">
                        <table>
                            <tr>
                                <td>Titel</td>
                            ...
                            <td><textarea name="tekstvak"  WRAP="soft"><?php echo($_POST['tekstvak']); ?></textarea></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><input class='btn-style' type="submit" name="button" value="Wijzigen"></td>
                            </tr>
                        </table>
                    </form>
                    <?php
                    if (empty($_POST['titel'])) {
                        echo ("Geef uw mededeling een titel!");
                        $_POST['titel'] = "";
                    } elseif (empty($_POST['tekstvak'])) {
                        echo ("Geef uw mededeling tekst!");
                        $_POST['tekstvak'] = "";
                    }
                    ?>
                </div>
