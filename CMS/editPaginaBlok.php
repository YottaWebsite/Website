            ...
            <div class="navbar-leegte">
                <div class="container">
                    ...
                    <form method="POST" action="doEditPaginaBlok.php">
                        <h1>Pagina Blokken wijzigen</h1><hr>
                        <table>
                            <tr>
                                <td> </td>
                                <td><h4><?php echo($id['paginanaam']); ?></h4></td>
                            </tr>
                            ...
                            <td><textarea name="tekstvak"  WRAP="soft"><?php echo($id['samenvatting']); ?></textarea></td>
                            </tr>
                            <tr>
                                <td><input type="hidden" name="bid" value="<?php echo $id['b_id']; ?>"</td>
