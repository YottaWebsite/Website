            ...
            <div class="navbar-leegte">
                <div class="container">
                    <?php
                        ...
                        <tr>
                        <td>Naam/Titel</td>
                        <td><input type = "text" name = "titel" value="<?php echo ($naam); ?>" ></td>
                        </tr>
                        <tr>
                        <td>Kop</td>
                        <td><?php newPaginaKop()
                        ...
                        <td><textarea name="tekstvak"  WRAP="soft"><?php echo ($tekst); ?></textarea></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><input class='btn-style' type="submit" name="button" value="Verzend"></td>
                        </tr>
                        </table>
                        </form>
                        <?php
                        if (isset($_POST['button'])) {
                            if (!isset($_POST['titel'])) {
                                echo ("Geef uw pagina een naam!");
                            }
                            if (!isset($_POST['tekstvak'])) {
                                echo ("Geef uw pagina tekst!");
                            } else {
                                addPagina($_POST['kop'], $_POST['titel'], $_POST['tekstvak']);
                                header("Location: doAddPage.php");
                            }
                        }
                        ?>
                    </div>
