...
<html lang="en">
    ...
    <body id="page-top" class="index">
        ...
        if ($_POST['titel'] != "" && $_POST['tekstvak'] != "") {
            editNieuws($_POST['id'], $_POST['titel'], $_POST['tekstvak']);
            header("Location: nieuws.php");
        }

        $id = editNieuwsForm($_POST['id']);
        ?>
        <!-- Navigatie -->
        ...
        <section>
            <div class="navbar-leegte">
                <div class="container">
                    <h1>Nieuws wijzigen</h1>  <!-- titel -->
                    <a href="nieuws.php">Nieuws weergeven</a><hr>

                    <form method="POST" action="doEditNieuws.php">
                        <table>
                            <tr>
                                <td>Titel</td>
