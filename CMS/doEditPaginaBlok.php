...
<html lang="en">
    ...
    <body id="page-top" class="index">
        ...
        if ($_POST['tekstvak'] != "") {
            editPaginaBlok($_POST['tekstvak'], $_POST['bid']);
            header("Location: PaginaBlok.php");
        }
        ?>
        <!-- Navigatie -->
        ...
        <section>
            <div class="navbar-leegte">
                <div class="container">
                    <h1>Pagina Blok wijzigen</h1>  <!-- titel --><hr>

                    <form method="POST" action="doEditPaginaBlok.php">
                        <table>
                            <tr>
                                <td></td>
                                <td><h4><?php echo($_POST['titel']); ?></h4></td>
                            </tr>
                            <tr>
                                <td>Tekst</td>
