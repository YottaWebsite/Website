...
<html lang="en">
    ...
    <body id="page-top" class="index">
        ...
        if (empty($_POST['titel'])) {
            echo ("Geef uw pagina een titel!");
            $_POST['titel'] = "";
        } elseif (empty($_POST['tekstvak'])) {
            echo ("Geef uw pagina tekst!");
            $_POST['tekstvak'] = "";
        } else {
            editOnderdeel($nummer, $pagina, $id, $_POST['volgorde'], $_POST['titel'], $_POST['tekstvak']);
            header("Location: onderdeel.php");
        }
        ?>
        <!-- Navigatie -->
        ...
        <section>
            <div class="navbar-leegte">
                <div class="container">
                    <h1>CMS Pagina's</h1>
                    <a href="onderdeel.php">Onderdeel weergeven</a>
