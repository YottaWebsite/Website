        ...
        <section>
            <div class="navbar-leegte">
                <div class="container">
                    ...
                    <?php
                    if (isset($_POST['yotta'])) {
                        getOnderdeelYotta();
                    }
                    if (isset($_POST['dienst'])) {
                        getOnderdeelDiensten();
                    }
        ...
        <section class="success" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <h4>Hosting</h4>
                        <p>Wij bieden u voordelige hostingpakketten met onbeperkt dataverkeer, e-mail aliassen en een uitstekende beveiliging tegen ongewenste personen.</p>
                    </div>
                    <div class="col-sm-3">
